...
* `plot_nclimgrid_monthly()` Creates a monthly faceted plot of measurement values, either monthly or normals
* `plot_nclimgrid_anomaly()` Creates a monthly faceted binned anomaly plot
